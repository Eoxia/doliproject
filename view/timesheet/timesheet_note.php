...
$help_url = '';
llxHeader('', $langs->trans('TimeSheet'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	// Object card
	// ------------------------------------------------------------
	$linkback = '<a href="'.dol_buildpath('/doliproject/timesheet_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
