...
require_once DOL_DOCUMENT_ROOT.'/custom/doliproject/class/facturerecstats.class.php';
...
if ($mode == 'customer') {
	$fileurlnb = DOL_URL_ROOT.'/viewimage.php?modulepart=doliproject&file=invoicerecsnbinyear-'.$year.'.png';
}
//if ($mode == 'supplier') {
//	$fileurlnb = DOL_URL_ROOT.'/viewimage.php?modulepart=doliproject&file=invoicesnbinyear-'.$year.'.png';
//}
...
if ($mode == 'customer') {
	$fileurlamount = DOL_URL_ROOT.'/viewimage.php?modulepart=doliproject&amp;file=invoicerecsamountinyear-'.$year.'.png';
}
//if ($mode == 'supplier') {
...
if (empty($user->rights->societe->client->voir) || $user->socid) {
	...
	if ($mode == 'customer') {
		$fileurl_avg = DOL_URL_ROOT.'/viewimage.php?modulepart=doliproject&file=invoicerecsaverage-'.$user->id.'-'.$year.'.png';
	}
//	if ($mode == 'supplier') {
...
//	}
	...
	if ($mode == 'customer') {
		$fileurl_avg = DOL_URL_ROOT.'/viewimage.php?modulepart=doliproject&file=invoicerecsaverage-'.$year.'.png';
	}
//	if ($mode == 'supplier') {
...
$h = 0;
$head = array();
$head[$h][0] = DOL_URL_ROOT.'/custom/doliproject/view/recurringinvoicestatistics.php?mode='.urlencode($mode);
