...
/**
 * \file    lib/doliproject_timesheet.lib.php
 * \ingroup doliproject
...
//	$upload_dir = $conf->doliproject->dir_output."/timesheet/".dol_sanitizeFileName($object->ref);
//	$nbFiles = count(dol_dir_list($upload_dir, 'files', 0, '', '(\.meta|_preview.*\.png)$'));
//	$nbLinks = Link::count($db, $object->element, $object->id);
//	$head[$h][0] = dol_buildpath("/doliproject/view/timesheet/timesheet_document.php", 1).'?id='.$object->id;
