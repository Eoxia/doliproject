...
/**
* \file    lib/doliproject_function.lib.php
* \ingroup doliproject
 ...
 */
function doliprojectshowdocuments($modulepart, $modulesubdir, $filedir, $urlsource, $genallowed, $delallowed = 0, $modelselected = '', $allowgenifempty = 1, $forcenomultilang = 0, $notused = 0, $noform = 0, $param = '', $title = '', $buttonlabel = '', $codelang = '', $morepicto = '', $object = null, $hideifempty = 0, $removeaction = 'remove_file', $active = 1, $tooltiptext = '')
{
 ...
 * @return  '' or $model
 */
function remove_indexdoliproject($model)
{
 ...
 */
function getListOfModelsDoliProject($db, $type, $maxfilenamelength = 0)
{
	global $conf, $langs;
	$liste = array();
	$found = 0;
