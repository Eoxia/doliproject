...
class TimeSheetLine extends CommonObjectLine
{
	 ...
	 */
	public $table_element = 'doliproject_ fk_timesheetdet';
	...
	public $fields = array(
		...
		'fk_timesheet'   => array('type'=>'integer:TimeSheet:custom/doliproject/class/timesheet.class.php:1', 'label'=>'TimeSheet', 'enabled'=>'1', 'position'=>60, 'notnull'=>1, 'visible'=>0,),
	...
	public function fetch($rowid)
	{
		...
		$sql .= ' FROM ' . MAIN_DB_PREFIX . 'doliproject_timesheetdet as tsd';
	...
	public function delete(User $user, $notrigger = false)
	{
		...
		$sql = "DELETE FROM " . MAIN_DB_PREFIX . "doliproject_timesheetdet WHERE rowid = " . $this->id;
