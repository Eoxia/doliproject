...
/**
 *	\file       doliproject/doliprojectindex.php
 *	\ingroup    doliproject
 *	\brief      Home page of doliproject top menu
 */
...
// Security check
//if (! $user->rights->doliproject->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("DoliprojectArea"));

print load_fiche_titre($langs->trans("DoliprojectArea"), '', 'doliproject.png@doliproject');
...
// Draft MyObject
if (! empty($conf->doliproject->enabled) && $user->rights->doliproject->read)
{
	$langs->load("orders");
