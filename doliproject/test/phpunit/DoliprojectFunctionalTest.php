...
/**
 * \file    test/phpunit/DoliprojectFunctionalTest.php
 * \ingroup doliproject
...
/**
 * Class DoliprojectFunctionalTest
 *
 ...
 *
 * @package Testdoliproject
 */
class DoliprojectFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDoliproject')->click();
		} else {
			// Disable the module
			$this->byHref('modDoliproject')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/doliproject/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('doliproject/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/doliproject/admin/about.php');
		$this->authenticate();
		return $this->assertContains('doliproject/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('doliprojectwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliproject_DoliprojectTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliproject_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
